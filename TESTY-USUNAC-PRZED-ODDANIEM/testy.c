...
void testy() {
...
#ifdef TEST1
    {
        ...
        // krok 1
        assert(!nand_connect_signal(&b, g0, 0));
        assert(!nand_connect_nand(g1, g0, 2));
        assert(!nand_connect_nand(g1, g0, 4));
        assert(!nand_connect_nand(g2, g0, 3));
        assert(!nand_connect_nand(g0, g0, 5));
        assert(!nand_connect_nand(g0, g0, 6));
